...
#include "TedPickup/Pickup.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodePickup() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	TEDPICKUP_API UClass* Z_Construct_UClass_APickup();
...
// End Cross Module References
	...
	template<> TEDPICKUP_API UClass* StaticClass<APickup>()
	{
		return APickup::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(APickup);
	APickup::~APickup() {}
	struct Z_CompiledInDeferFile_FID_TedPickup_Source_TedPickup_Pickup_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TedPickup_Source_TedPickup_Pickup_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APickup, APickup::StaticClass, TEXT("APickup"), &Z_Registration_Info_UClass_APickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APickup), 4046305759U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TedPickup_Source_TedPickup_Pickup_h_1643073055(TEXT("/Script/TedPickup"),
		Z_CompiledInDeferFile_FID_TedPickup_Source_TedPickup_Pickup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TedPickup_Source_TedPickup_Pickup_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
