...
#include "BearsGame/EventManagerActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEventManagerActor() {}
// Cross Module References
	BEARSGAME_API UClass* Z_Construct_UClass_AEventManagerActor();
	BEARSGAME_API UClass* Z_Construct_UClass_AEventManagerActor_NoRegister();
...
// End Cross Module References
	...
	template<> BEARSGAME_API UClass* StaticClass<AEventManagerActor>()
	{
		return AEventManagerActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AEventManagerActor);
	AEventManagerActor::~AEventManagerActor() {}
	struct Z_CompiledInDeferFile_FID_BearsGame_Source_BearsGame_EventManagerActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BearsGame_Source_BearsGame_EventManagerActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AEventManagerActor, AEventManagerActor::StaticClass, TEXT("AEventManagerActor"), &Z_Registration_Info_UClass_AEventManagerActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEventManagerActor), 885980433U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BearsGame_Source_BearsGame_EventManagerActor_h_2974447984(TEXT("/Script/BearsGame"),
		Z_CompiledInDeferFile_FID_BearsGame_Source_BearsGame_EventManagerActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_BearsGame_Source_BearsGame_EventManagerActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
