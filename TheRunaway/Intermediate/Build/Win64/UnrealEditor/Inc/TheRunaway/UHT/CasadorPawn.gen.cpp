...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACasadorPawn_Statics::NewProp_Health_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Casador Param" },
		{ "ModuleRelativePath", "CasadorPawn.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACasadorPawn_Statics::NewProp_Health = { "Health", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACasadorPawn, Health), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACasadorPawn_Statics::NewProp_Health_MetaData), Z_Construct_UClass_ACasadorPawn_Statics::NewProp_Health_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACasadorPawn_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACasadorPawn_Statics::NewProp_Health,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_CasadorPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACasadorPawn, ACasadorPawn::StaticClass, TEXT("ACasadorPawn"), &Z_Registration_Info_UClass_ACasadorPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACasadorPawn), 58681477U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_CasadorPawn_h_4266673643(TEXT("/Script/TheRunaway"),
