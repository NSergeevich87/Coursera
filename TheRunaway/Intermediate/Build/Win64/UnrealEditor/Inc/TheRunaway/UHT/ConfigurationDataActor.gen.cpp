...
#include "TheRunaway/ConfigurationDataActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeConfigurationDataActor() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	ENGINE_API UClass* Z_Construct_UClass_UDataTable_NoRegister();
	THERUNAWAY_API UClass* Z_Construct_UClass_AConfigurationDataActor();
	THERUNAWAY_API UClass* Z_Construct_UClass_AConfigurationDataActor_NoRegister();
...
// End Cross Module References
	...
	template<> THERUNAWAY_API UClass* StaticClass<AConfigurationDataActor>()
	{
		return AConfigurationDataActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AConfigurationDataActor);
	AConfigurationDataActor::~AConfigurationDataActor() {}
	struct Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_ConfigurationDataActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_ConfigurationDataActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AConfigurationDataActor, AConfigurationDataActor::StaticClass, TEXT("AConfigurationDataActor"), &Z_Registration_Info_UClass_AConfigurationDataActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AConfigurationDataActor), 1529927029U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_ConfigurationDataActor_h_1633903714(TEXT("/Script/TheRunaway"),
		Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_ConfigurationDataActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TheRunaway_Source_TheRunaway_ConfigurationDataActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
